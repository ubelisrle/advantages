...
/*
 * Template Name: Yacht Case Study
...
?>
    ...
    <section id="case-single">
                ...
                <img src="<?php bloginfo('template_directory'); ?>/img/bg/video-left.svg" alt="" class="top-shape">
                    ...
                    <div class="video-holder">
                        <div class="embed-container">
                            <a href="<?php the_field('video_url_std'); ?>" data-fancybox="gallery">
                            <?php
                            $imageID = get_field('video_screenshot_std');
                        ...
                        <!-- // container -->
                        <span class="caption"><?php the_field('video_caption_std'); ?><img src="<?php bloginfo('template_directory'); ?>/img/ico/arrow-up.svg" alt=""></span>                      
                    </div>
                    <!-- // video  -->                  
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="content-block">
                            <h2><?php the_field('block_title_about_std'); ?></h2>
                            <?php the_field('block_text_about_std'); ?>
                                <a href="<?php the_field('button_link_about_std'); ?>" class="btn-cta"><?php the_field('button_label_about_std'); ?></a>
                        </div>
                    </div>
                    <!-- // content block  -->
                    <div class="col-lg-5 offset-lg-1 image-col col-md-6 offset-md-0">
                        <div class="image-holder">
                            ...
                            <img src="<?php the_field('featured_image_about_std'); ?>" alt="" class="img-responsive">
                ...
                <div class="row">
                    <div class="col-lg-5 image-col col-md-6">
                        <div class="image-holder">
                            ...
                            <img src="<?php the_field('featured_image_results_std'); ?>" alt="" class="img-responsive">

                            <span class="caption"><?php the_field('image_caption_results_std'); ?><img src="<?php bloginfo('template_directory'); ?>/img/ico/arrow-up.svg" alt=""></span>
                        </div>
                    </div>
                    <!-- // image  -->
                    <div class="col-lg-6 offset-lg-1 col-md-6 offset-md-0">
                        <div class="content-block">
                            <h2><?php the_field('block_title_results_std'); ?></h2>
                            <?php the_field('block_content_results_std'); ?>
                            <div class="awards">
                                <?php if( have_rows('awards_results_std') ): ?>
                                <?php while( have_rows('awards_results_std') ): the_row(); ?>
        ...
        <div class="case-portfolio">
            <div class="container">
                <div class="row">
                <?php if( have_rows('our_work_std') ): ?>
                    <?php while( have_rows('our_work_std') ): the_row(); ?>

                        <div class="col-lg-4 col-sm-4">
                            <div class="portfolio-card">
                                <span class="caption"><?php the_sub_field('block_title'); ?><img src="<?php bloginfo('template_directory'); ?>/img/ico/down-arrow.svg" alt=""></span>
        ...
        <div class="case-testimonials">
            <div class="container">
                <div class="reviews-wrapper">
                    <h3><?php the_field('block_title_test_std'); ?></h3>
                    <div class="review-block">
                        <?php the_field('testimonial_text_std'); ?>
                        <span class="author"><?php the_field('testimonial_author_std'); ?></span>
                    </div>
                    <!-- // block  -->
                </div>
                <!-- // wrapper  -->
