...
return array(
  ...
  'edit.php', // Posts
  'edit.php?post_type=casestudies', // Custom type five  
  'edit.php?post_type=management', // Custom type five  
  'edit.php?post_type=team', // Custom type five  
...
#adminmenu div.wp-menu-name {
    border-bottom:1px dotted #D18604!important;
}
...
#adminmenu li.wp-has-submenu.wp-not-current-submenu:hover:after {
  border-right-color:#FDB232!important;
}
